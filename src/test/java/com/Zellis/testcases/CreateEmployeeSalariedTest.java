...
public class CreateEmployeeSalariedTest extends BaseClass {

	public CreateEmployeeAllPage createEmp;
	public UiUtilities utility;
	private static final Logger logger = LogManager.getLogger(CreateEmployeeSalariedTest.class);
	...
	public void verifyDCCurrentFuturePost() throws InterruptedException, IOException, ParseException {
		...
		String DCSalariedPositionStatus = currentFuturePost.get(0).get("PositionStatusSalaried");
		String DCPostSalaried=currentFuturePost.get(0).get("DCPostSalaried");

		createEmp.MoveToCurrentFuturePost(CurrentPostStartDate, DCPostSalaried);
		createEmp.enterServiceConditions(DCSalariedPositionStatus);
		createEmp.enterGrade();
	}
